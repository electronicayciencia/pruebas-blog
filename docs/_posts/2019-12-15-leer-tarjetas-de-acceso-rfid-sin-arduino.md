...
{% include image.html max-width="480px" file="detector_de_envolvente.gif" caption="Detector de envolvente. [Wikipedia.]({{page.assets}}/C_Simple_envelope_detector.gif)" %}
